...
def aggregate_network(input_file, output_file):
    ...
    aggregated_df.columns = [
        'entity', 'cluster', 'topic', 'article_id', 'tweet_id', 'parent_id', 'entity_type',
    ...
    aggregated_df = aggregated_df[['entity', 'cluster', 'topic', 'article_id', 'tweet_id', 'parent_id', 'entity_type',
...
if __name__ == "__main__":
    input_file = 'twitter_entity_topic_network.csv'
    output_file = 'aggregated_twitter_entity_topic_network.csv'
