...
def aggregate_network(input_file, output_file):
    ...
    aggregated_df.columns = [
        'entity', 'cluster', 'topic', 'article_id', 'comment_id', 'parent_id', 'entity_type',
    ...
    aggregated_df = aggregated_df[['entity', 'cluster', 'topic', 'article_id', 'comment_id', 'parent_id', 'entity_type',
