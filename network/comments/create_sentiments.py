...
def load_and_process_comments_data(paths):
    ...
    return processed_texts, raw_text_list, comment_id_list, parent_id_list, entities_list
...
def sentiment_analysis_on_comments(raw_texts, comment_ids, parent_ids, entities_list):
    comment_entity_sentiment = []

    for text, comment_id, parent_id, entities in zip(raw_texts, comment_ids, parent_ids, entities_list):
...
def main():
    ...
    processed_comment_texts, raw_comment_texts, comment_ids, parent_ids, entities_list = load_and_process_comments_data(
        comment_paths)

    # Perform sentiment analysis on comments
    sentiment_analysis_on_comments(raw_comment_texts, comment_ids, parent_ids, entities_list)
